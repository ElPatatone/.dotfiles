...
_G.packer_plugins = {
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/elpatatone/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["neoscroll.nvim"] = {
    loaded = true,
    path = "/home/elpatatone/.local/share/nvim/site/pack/packer/start/neoscroll.nvim",
  ...
  ["nvim-ts-rainbow2"] = {
    loaded = true,
    path = "/home/elpatatone/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow2",
